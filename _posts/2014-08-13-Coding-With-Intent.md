...
This blog post kick’s off a series that will venture through different aspects of software engineering with javascript. I’ll present topics in context and application to the famousnQueens puzzle. A variety of topics will be covered in this series including recursion, “this”, instantiation patterns, time complexity and test driven development.

To get started, I’m going to outline a process I try to practice when I write code with the intent of solving a problem. This process has been directly extrapolated from a lecture entitled Alogrithm of an Alogrithm given by Hack Reactor instructor Phillip Alexander.
